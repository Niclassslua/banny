...
export const ControlButton: React.FC<ControlButtonProps> = ({
    ...
    return (
        <button
            ...
            style={mergedStyle}
            className={clsx(
                "inline-flex items-center justify-center gap-2 rounded-lg border transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#A1E2F8]",
                active
