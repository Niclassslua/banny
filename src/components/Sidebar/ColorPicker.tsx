// components/Sidebar/ColorPicker.popper.tsx
"use client";
...
const ColorPickerPopper: React.FC<ColorPickerProps> = ({
                                                           color,
                                                           setColor,
                                                           darkMode,
                                                           isVisible,
    ...
    useEffect(() => {
        if (!isVisible || !triggerRef.current || !pickerRef.current) return;
        const instance = createPopper(triggerRef.current, pickerRef.current, {
            placement: "top",
            modifiers: [
        ...
        <div className="relative">
            ...
            {isVisible &&
                ...
                createPortal(
                    <div
                        ref={pickerRef}
                        className="z-[10000] w-[18rem] rounded-2xl border border-white/10 bg-zinc-900/95 p-4 shadow-[0_25px_70px_-35px_rgba(192,230,244,0.6)] backdrop-blur"
                    ...
                    >
                        <ColorPicker
                            style={{
                                ...
                                rbgcpInputLabel: { color: "rgb(225, 233, 240)" },
                                ...
                                rbgcpControlBtn: { color: "rgb(225, 233, 240)" },
                                rbgcpControlIcon: { stroke: "rgb(225, 233, 240)" },
                                rbgcpControlIcon2: { fill: "rgb(225, 233, 240)" },
                                rbgcpControlInput: { color: "white" },
                                rbgcpControlBtnSelected: {
                                    backgroundColor: "rgba(161, 226, 248, 0.18)",
                                    color: "#A1E2F8",
                                },
                                rbgcpDegreeIcon: { color: "rgb(225, 233, 240)" },
                                rbgcpColorModelDropdown: {
                                    backgroundColor: "rgba(8,8,12,0.85)",
                                    borderRadius: "12px",
                                },
                                rbgcpComparibleLabel: { color: "rgb(225, 233, 240)" },
                            }}
                            value={color}
